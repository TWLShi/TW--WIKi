...
- [[查询路由/问题路由树.md]] —— 问题路由树（决策树）
- [[查询路由/问题维度映射体系.md]] —— 多维问题维度映射
- [[查询路由/多维问题与要素识别.md]] —— 多维要素识别
- [[查询路由/补充问题类型维度.md]] —— 补充问题类型

### **3. AI_Support 多智能体决策支持**（最重要模块）
- [[AI支持/01_AILLM应急指挥智能决策支持.md]] —— LLM应急指挥决策
- [[多智能体架构/消防多智能体架构.md]] —— 多智能体整体架构
- [[多智能体架构/消防多智能体应用.md]] —— 多智能体实际应用
- [[多智能体架构/接处警AI总体流程.md]] —— 接处警AI总体流程
