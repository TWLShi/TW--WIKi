...
### 1. 核心设计文档
- [[00_非对称问询路由设计.md]] —— **非对称问询路由设计（V2.0）**（最重要）
...
### 2. 话术与执行
- [[01_标准话术库V1.md]] —— 标准话术库（位置确认、火情规模、人员伤亡等）

### 3. 辅助文档
- [[Query_Routing/README.md]] —— 本模块总说明
...
**推荐阅读顺序**：
1. [[00_非对称问询路由设计.md]]（理解整体设计）
2. [[问题路由树.md]]（算法核心）
3. [[01_标准话术库V1.md]]（实际执行）
4. [[问题维度映射体系.md]]（维度定义）
...
- [[03_Constraint_Validation_Mechanism.md]]（下游依赖）
- [[AI_Support/01_AILLM应急指挥智能决策支持.md]]（AI决策前置）
- [[02_Part逻辑映射索引]]
